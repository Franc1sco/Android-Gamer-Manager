package es.ilerna.gamermanager.database

import es.ilerna.gamermanager.database.DatabaseConstants.DATABASE_NAME
import es.ilerna.gamermanager.database.DatabaseConstants.FOLLOWED_BY_ID
import es.ilerna.gamermanager.database.DatabaseConstants.FOLLOWER_ID
import es.ilerna.gamermanager.database.DatabaseConstants.GAMEID
import es.ilerna.gamermanager.database.DatabaseConstants.GAMEVALIDATED
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_COMPANY
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_GENRE
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_IMAGE
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_NAME
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_PLATFORM
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_POINTS
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_STATUS
import es.ilerna.gamermanager.database.DatabaseConstants.GAME_USERID
import es.ilerna.gamermanager.database.DatabaseConstants.ID
import es.ilerna.gamermanager.database.DatabaseConstants.NICK_USER
import es.ilerna.gamermanager.database.DatabaseConstants.PASSWORD_USER
import es.ilerna.gamermanager.database.DatabaseConstants.PRIVATE_USER
import es.ilerna.gamermanager.database.DatabaseConstants.TABLE_FOLLOWERS
import es.ilerna.gamermanager.database.DatabaseConstants.TABLE_GAMES
import es.ilerna.gamermanager.database.DatabaseConstants.TABLE_USER
import es.ilerna.gamermanager.database.DatabaseConstants.TABLE_USERGAMES
